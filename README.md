...
- [Parcel (Client Mode)](https://github.com/themesberg/flowbite-react-template-parcel-client)
- [Parcel (Server Mode)](https://github.com/themesberg/flowbite-react-template-parcel-server)
- [React Router (Framework Mode)](https://github.com/themesberg/flowbite-react-template-react-router-framework)
- [React Router (Data Mode)](https://github.com/themesberg/flowbite-react-template-react-router-data)
- [React Router (Declarative Mode)](https://github.com/themesberg/flowbite-react-template-react-router-declarative)
